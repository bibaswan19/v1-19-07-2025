        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className='col-span-4 md:col-span-4 lg:col-span-4'>
            <div className="flex items-center gap-2">
              ...
              />
              <h5 className="text-lg text-black/60">37, Nandalal Basu Sarani, College Para, Hakim Para, Siliguri, West Bengal 734001</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Icon
                ...
                className="text-primary text-3xl inline-block me-2"
              />
              <h5 className="text-lg text-black/60">+91 9641592339</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Icon
                icon="tabler:folder"
                className="text-primary text-3xl inline-block me-2"
              />
              <h5 className="text-lg text-black/60">demo@gmail.com</h5>
            </div>
          </div>
        </div>

        <div className='mt-10 lg:flex items-center justify-between'>
          <h4 className='text-black/50 text-sm text-center lg:text-start font-normal'>© 2025 All Rights Reserved by <Link href="https://www.siplhub.com/" target="_blank" className="hover:text-primary"> Sikharthy Infotech </Link></h4>
          ...
          <h4 className='text-black/50 text-sm text-center lg:text-start font-normal'>Distributed by <Link href="https://themewagon.com/" target="_blank" className="hover:text-primary"> demo-text</Link></h4>
        </div>
      </div>
    </footer>
  )
